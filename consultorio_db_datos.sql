...
('Emergencias Prepaga', 40, NULL, NULL);
...
---------------------------------------------------------------------------
-- INSERTS PROFESIONAL x ESPECIALIDAD
---------------------------------------------------------------------------
...
('Carlos','Duarte','29001122','1980-09-23','11-5555-7788','cd@x.com','Cabildo 2000',7,'9999',0);

---------------------------------------------------------------------------
-- GENERACIÓN DE HORARIOS AUTOMÁTICOS (CORREGIDO)
---------------------------------------------------------------------------
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                ...
                INSERT INTO HorarioAtencion (id_profesional_especialidad, id_consultorio, dia_semana, hora_inicio, hora_fin)
                SELECT 
                    PE.id_profesional_especialidad,
                    @consultorio,
                    @diaText,
                    @inicio,
                    @fin
